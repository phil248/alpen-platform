...
Plugin files use `~~category` as a placeholder for whatever tool the user connects in that category. For example, `GitHub control` might mean GitHub, GitLab, or any other VCS with an MCP server.
...
| Source control | `GitHub control` | GitHub | GitLab, Bitbucket |
...
| CI/CD | `GitHub Actions/CD` | — | CircleCI, GitHub Actions, Jenkins, BuildKite |
